  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at center, rgba(79,70,229,0.1) 0%, transparent 65%)",
        filter: "blur(48px)",
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, transparent 0%, rgba(91,156,246,0.25) 25%, rgba(168,85,247,0.15) 45%, rgba(79,70,229,0.25) 70%, transparent 100%)",
        filter: "blur(4px)",
        opacity: 0.5,
